class OrderLinesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @order_line.save
        format.html { redirect_to @order_line, notice: 'Sales order_line was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @order_line.update(order_line_params)
        format.html { redirect_to @order_line, notice: 'Sales order_line was successfully updated.' }
  ...
  def destroy
    @order_line.destroy
    respond_to do |format|
      format.html { redirect_to order_lines_url, notice: 'Sales order_line was successfully destroyed.' }
