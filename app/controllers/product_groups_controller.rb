class ProductGroupsController < ApplicationController
  ...
  private
    ...
    def product_group_params
      params.require(:product_group).permit(:name, :description, :onlineViewLabel, :posViewLabel, :posViewLabel, :headerImagePath, :displayIndex, :visibleOnline, :visibleOnPos, :enabled, :deleted, :user_id, :product_category_id)
    end
end
